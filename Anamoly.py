...
# ----------------------------------------------------------
# STEP 6 — Transformer Autoencoder
# ----------------------------------------------------------
...
print("\nSTEP 10 — Grafana style visualization")
...
for e in examples:
    ...
    print("Input:", e, " -> ", result, "score:", round(err, 4))

print("\nPipeline complete.")"pull_image"
]
